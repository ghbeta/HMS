...
public class Secureddefault extends Security.Authenticator {
    ...
    public String getUsername(Http.Context ctx) {
       ...
       if(current.roles.equals(UserRoll.Defaultuser.toString())||current.roles.equals(UserRoll.Students.toString())||current.roles.equals(UserRoll.Assistants.toString())||current.roles.equals(UserRoll.Teachers.toString())){
